...
class Game:
    ...
    def mostrar_tela_start(self):
        pygame.mixer.music.load(
            os.path.join(self.diretorio_audios, constantes.MUSICA_START))
        pygame.mixer.music.play()

        self.mostrar_start_logo(constantes.LARGURA/2, 20)
        self.mostrar_texto(
            "Pressione qualquer tecla pra iniciar.",
            28,
            constantes.AMARELO,
        ...
        while esperando:
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.KEYUP:
                    ...
                    pygame.mixer.Sound(
                        os.path.join(self.diretorio_audios,
                                     constantes.TECLA_START)
                    ).play()
